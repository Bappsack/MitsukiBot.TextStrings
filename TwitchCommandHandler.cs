...
namespace Twitch_Chatbot_Mitsuki
{
    ...
    {
        private static string Channel => Properties.Settings.Default.JoinedChannel;
        ...
        /// <returns></returns>
        public static string HandleHelpCommands(string context, dynamic data)
        {
            ...
            return args[1].ToLower() switch
            {
                ...
                // Chat Command Help
                "cd" or "cooldown" or "cap" or "timecapsule" => string.Format(TextStrings.HelpCommandsStrings.Cooldown, Properties.Settings.Default.GeneralTradeCooldown),
        ...
        {
            return Utils.Misc.FoodList[ran.Next(0, Utils.Misc.FoodList.Count)];
        }
    }
}