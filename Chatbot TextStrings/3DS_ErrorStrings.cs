namespace TextStrings
{
    public static class _3DSErrorStrings
    {
        ...
        public static string DepositNotFound = "Your deposit Pokémon was not found, please request again! Check '!help gts' for troubleshooting steps! Remember, mythical Pokémon can't be requested from the Gen 7 (SUMO/USUM) GTS trades!";
