namespace Chatbot_TextStrings
{
    public static class YT_ErrorStrings
    {
        ...
        public static readonly string YT_Not_In_Galar = "@{0} Your requested Pokémon doesn't exist in Galar. Trade cancelled!";
        public static readonly string YT_Not_In_Sinnoh = "@{0} Your requested Pokémon doesn't exist in Sinnoh. Trade cancelled!";
        public static readonly string YT_Not_In_Hisui = "@{0} Your requested Pokémon doesn't exist in Hisui. Trade cancelled!";
