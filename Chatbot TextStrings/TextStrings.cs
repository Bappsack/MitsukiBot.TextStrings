...
namespace Twitch_Chatbot_Mitsuki
{
    public static class TextStrings
    {
        ...
        public static class HelpCommandsStrings
        {
            ...
            public static string Format = "Deposit: ___, Request: ___, Form: ___, Gmax: ___, IsShiny: ___, Gender: ___, Nickname: ___, Ball: ___, Level: ___, Item: ___, Ability: ___, Nature: ___, Move1: ___, Move2: ___, Move3: ___, Move4: ___, EV_HP: ___, EV_ATK: ___, EV_DEF: ___, EV_SPA: ___, EV_SPD: ___, EV_SPE: ___, etc.";
