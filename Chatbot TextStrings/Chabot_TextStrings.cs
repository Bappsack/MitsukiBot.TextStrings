...
namespace TextStrings
{
    ...
    public static class Chatbot_TextStrings
    {
        ...
        public static class HelpCommandsStrings
        {
            ...
            public readonly static string ErrorGTS = "[3DS] 1) Correct trade prefix? (Gen 6 = !tradeORAS, Gen 7 = !tradeUSUM), 2) Correct friend code? (!myfc), 3) Correct Pokémon for Deposit & Request? (Deposit = Pokémon deposited, Request = Pokémon wanted), 4) Specified deposit Pokémon if using Showdown set? (Add 'Deposit: [Pokémon]' after 1st line), 5) Correct spelling of wanted Pokémon?, 6) Gender & Level left at default settings?, 7) Try using a different deposit Pokémon, 8) Make sure you aren't requesting a mythical Pokémon in SM/USUM";
