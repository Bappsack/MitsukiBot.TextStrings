...
namespace TextStrings
{
    ...
    public static class Chatbot_TextStrings
    {
        ...
        public static class HelpCommandsStrings
        {
            ...
            public static string ErrorInvalid = "If you are using a Showdown set, do not put 'Request:' in your command. Otherwise, the bot is cancelling the trade because your customizations are not legal. Common issues include requesting an invalid ability, ball, level, and/or moveset, so try changing/removing these customizations first. If you require further assistance, ask for help in the #support channel in our Discord server!";
