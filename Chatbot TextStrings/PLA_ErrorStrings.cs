namespace TextStrings
{
    public static class PLA_TextStrings
    {
        public static class ErrorStrings
        {
            ...
            public static string NoTradePartnerFound = "No trade partner found! Check '!help PLA' for troubleshooting steps or ask for help in the #support channel in our Discord server!";
