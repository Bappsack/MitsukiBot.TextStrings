namespace TextStrings
{
    public static class PLA_TextStrings
    {
        public static class ErrorStrings
        {
            ...
            public readonly static string NoTradePartnerFound = "No trade partner found! Check '!help linkpla' for troubleshooting steps or ask for help in the #support channel in our Discord server!";
            public readonly static string NoTradePartnerFound2 = "No trade partner found, please request again! Check '!help linkpla' for troubleshooting steps or ask for help in the #support channel in our Discord server!";
