...
{
    public static class PLZA_TextStrings
    {
        public static class ErrorStrings
        {
            public readonly static string NotOnOverworldAfterStart = "We had trouble starting the search, please request again!";
            public readonly static string NoTradePartnerFound = "No trade partner found! Check '!help linkplza' for troubleshooting steps or ask for help in the #support channel in our Discord server!";
            public readonly static string NoTradePartnerFound2 = "No trade partner found, please request again! Check '!help linkplza' for troubleshooting steps or ask for help in the #support channel in our Discord server!";
        ...
        {
            public readonly static string UserTurnStarted = "/me VoteYea @{0} It's your turn now, please start searching, you have 30 seconds to match with me! VoteYea";
        ...
        {
            public readonly static string UserTurnStarted = "<@{0}> It's your turn now, please start searching, you have 30 seconds to match with me!";
            public readonly static string UserFound = "<@{0}> I found you, Trainer Name: {1}, waiting until you select a Pokémon! If that isn't you, please change your Link Code to a harder one!";
        }
    }
}
